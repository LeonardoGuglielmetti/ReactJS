      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        <Container>
          <Link className="navbar-brand" to={"/"}>
            <Navbar.Brand href="#home"> Leo´s Room</Navbar.Brand>
          </Link>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav className="me-auto">
              ...
              <Nav.Link href="#we">What is Leo´s Room?</Nav.Link>
              <NavDropdown title="Products" id="collasible-nav-dropdown">
                <NavDropdown.Item href="/category/t-shirts">T-Shirts</NavDropdown.Item>
                <NavDropdown.Item href="/category/pants">
                  Pants
                </NavDropdown.Item>
